...
function printStrings(array) {
  ...
  let pri = array.toString();
  console.log(pri.trim().repeat(2));
}
...
function concatenateStrings(array, subString) {
  ...
  // Виводимо результат
  let concat = array.toString();
  console.log(concat.includes(subString));
}
...
function swapMinMax(array) {
  /*// Ініціалізуємо дві змінні (max і min) з першим елементом масиву. Ці змінні будуть 
  використовуватися для зберігання максимального та мінімального значень в масиві.
  // Ініціалізуємо дві змінні (maxIndex і minIndex) з нульового значення. Ці змінні 
  будуть використовуватися для зберігання індексів максимального та мінімального значень 
  в масиві.
  ...
  // Умова if перевіряє, чи є поточний елемент масиву більшим за поточне максимальне 
  значення. Якщо це так, оновлюємо max з поточним елементом масиву та maxIndex з поточним 
  індексом.
  // Умова else if перевіряє, чи є поточний елемент масиву меншим за поточне мінімальне 
  значення. Якщо це так, оновлюємо min з поточним елементом масиву та minIndex з поточним 
  індексом.
  // Застосовуємо деструктуризацію масиву для обміну місцями мінімального та максимального
   значення в масиві.
  ...
  */
  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i] > max) {
      max = maxIndex = array[i];
    } else if (array[i] < min) {
      min = minIndex = array[i];
    }
  }
  let [y, a, b, c, x] = array;
  let arrayM = [maxIndex, a, b, c, minIndex + 1];
  return console.log(arrayM);
}
...
function replaceNumbers(arr) {
  ...
  for (let ii = 0; ii < arr.length; ii++) {
    if (arr[ii] > 10) {
      arrRe[ii] = "Greater than 10";
    } else if (arr[ii] <= 10) {
      arrRe[ii] = "Less than or equal to 10";
    }
  }
  console.log(arrRe);
}
